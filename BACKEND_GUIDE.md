...
| `SUPABASE_URL` | Supabase REST base | `{SUPABASE_URL}/rest/v1/{table}` |
| `SUPABASE_SERVICE_KEY` | `apikey` + `Authorization: Bearer` headers | Service role key (server-side use only) |
